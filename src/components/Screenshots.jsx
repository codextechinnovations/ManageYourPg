          ...
          <div className="flex flex-col lg:flex-row items-center justify-center gap-12">
            ...
            >
              ...
              <div className="flex items-center justify-center gap-4 mt-8">
                <button onClick={prevSlide} className="p-2 rounded-full bg-white/5 hover:bg-white/10 transition-all" aria-label="Previous screenshot">
                ...
                <div className="flex gap-2">
                  {screens.map((_, i) => (
                    <button
                      ...
                      className={`w-1.5 h-1.5 rounded-full transition-all ${i === activeIndex ? 'bg-white w-6' : 'bg-white/30 hover:bg-white/50'}`}
                      aria-label={`Go to screenshot ${i + 1}`}
                    />
                  ))}
                </div>
                <button onClick={nextSlide} className="p-2 rounded-full bg-white/5 hover:bg-white/10 transition-all" aria-label="Next screenshot">
